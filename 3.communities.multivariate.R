# 2 excersices: 1 about multivariate analysis, the other about relation of species with time.
...
# detrended correspomdemce analysis (DCA) -> decorana

ord <- decorana(dune)
summary(ord)
# what we need to know is the lenght of the new axis, how log is the range inside each axises,
# we can use this data to scale the analysis
# To obtain the range and percetage of data in each axis (graph on note)
